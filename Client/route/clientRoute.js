...
forgerockApp
    .config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        $routeProvider
            ...
            // route for The implicit flow
            .when('/ClientCredentialGrantFlow', {
                templateUrl : 'pages/PasswordGrantFlow.html',
                controller  : 'ClientCredentialGrantFlowController'
            })
...
forgerockApp.controller('ClientCredentialGrantFlowController', ['$scope', '$http', 'AccessToken',  function($scope, $http, AccessToken){
    $scope.baseURL = baseURL;
    ...
    $scope.startFlow = function(configID) {
        ...
        $scope.accessTokenRequest = {
            ...
            data: "grant_type=client_credentials&scope=" + $scope.config.scope
        };
        $scope.accessTokenRequest.status = {};
        $scope.accessTokenRequest.status.isSent = false;
        $scope.warnings = [];
